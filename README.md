...
## [函数重载 默认参数](./语言/函数/func_overload.cpp)
```cpp
// 参数 类型 个数 顺序 可以重载
// const type* 可以重载
#include <iostream>
...
```
## [rvo(返回值优化) c++中编译器会进行返回值优化](./语言/函数/rvo.cpp)
```cpp
#include <iostream>
...
```
### [friend 友元类](./语言/类/friend_class.cpp)
```cpp
#include <iostream>
...
```
### deque双端队列 快速的两端插入删除元素
* [deque](./语言/STL/deque.cpp)
```cpp
#include <iostream>
#include <deque>
...
```
### [map multimap set multiset 自动排序默认从小到大(排序会消耗资源) 快速的查找元素 unordered_map unordered_multimap 快速查找](./语言/STL/map.cpp)
```cpp
#include <iostream>
#include <map>
#include <string>
